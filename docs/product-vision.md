...
**Magic moment design**
The user types a 2-sentence idea, hits generate, and within ±2 minutes reads an honest verdict (strong/weak/pivot) + 3 fatal flaws + a draft feature tree. The "aha": _"Oh, this tool actually thinks with me, not just agrees with me."_ This is fully achievable in the MVP.
